...
You may use function-based views, class-based views, or a combination of both. Follow proper API naming conventions throughout the project. Review the videos *Function- and class-based views* and *Naming conventions* for details.
